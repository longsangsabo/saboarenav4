            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Icon(Icons.star, size: 12, color: AppTheme.accentLight),
                      SizedBox(width: 4),
                      Text(
                      ...
                      Icon(Icons.access_time,
                          size: 12, color: AppTheme.textDisabledLight),
                      SizedBox(width: 4),
                      Text(
                  ...
                  if (participant.club != null) ...[
                    ...
                    Row(
                      children: [
                        Icon(Icons.group, size: 12, color: AppTheme.primaryLight),
                        SizedBox(width: 4),
                        Text(
                          participant.club!,
                          style: TextStyle(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.check_circle,
                              size: 16, color: AppTheme.successLight),
                          SizedBox(width: 8),
                          const Text("Duyệt"),
                        ],
                      ),
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.remove_circle,
                            size: 16, color: AppTheme.errorLight),
                        SizedBox(width: 8),
                        const Text("Loại bỏ"),
                      ],
                    ),
  ...
  Widget _buildEmptyState() {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(Icons.group_off, size: 64, color: AppTheme.textDisabledLight),
          SizedBox(height: 16),
          Text(
