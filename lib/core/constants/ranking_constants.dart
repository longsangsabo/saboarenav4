...
class RankingConstants {
  ...
  // Vietnamese rank names and descriptions
  static const Map<String, Map<String, String>> RANK_DETAILS = {
    ...
    RANK_K_PLUS: {
      'name': 'Tập Sự+',
      'name_en': 'Beginner+',
      'description': 'Sắt ngưỡng lên I',
      'description_en': 'About to reach I rank',
      'color': '#A0522D',
    },
    RANK_I: {
      'name': 'Sơ Cấp',
    ...
    RANK_I_PLUS: {
      'name': 'Sơ Cấp+',
      'name_en': 'Novice+',
      'description': 'Sắt ngưỡng lên H',
      'description_en': 'About to reach H rank',
      'color': '#DEB887',
    },
    RANK_H: {
      'name': 'Trung Cấp',
    ...
    RANK_H_PLUS: {
      'name': 'Trung Cấp+',
      'name_en': 'Intermediate+',
      'description': 'Chuẩn bị lên G',
      'description_en': 'Preparing for G rank',
      'color': '#B0B0B0',
    },
    RANK_G: {
      'name': 'Khá',
    ...
    RANK_G_PLUS: {
      'name': 'Khá+',
      'name_en': 'Good+',
      'description': 'Trình phong trào "ngon"; sắt ngưỡng lên F',
      'description_en': 'Good recreational level; about to reach F',
      'color': '#FFA500',
    },
    RANK_F: {
      'name': 'Giỏi',
    ...
    RANK_F_PLUS: {
      'name': 'Giỏi+',
      'name_en': 'Skilled+',
      'description': 'Safety & spin control khá chắc; sắt ngưỡng lên E',
      'description_en': 'Good safety & spin control; about to reach E',
      'color': '#FF4500',
    },
    RANK_E: {
      'name': 'Xuất Sắc',
    ...
    RANK_E_PLUS: {
      'name': 'Chuyên Gia',
      'name_en': 'Expert',
      'description': 'Điều bi phức tạp, safety chủ động; sắt ngưỡng lên D',
      'description_en': 'Complex ball control, proactive safety; near D level',
      'color': '#B22222',
    },
  };
