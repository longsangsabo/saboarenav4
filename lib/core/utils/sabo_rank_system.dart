...
class SaboRankSystem {
  ...
  /// SABO rank mapping từ tài liệu reference
  static const Map<String, Map<String, dynamic>> rankEloMapping = {
    'K': {'elo': 1000, 'skill': '2-4 bi khi hình dễ; mới tập', 'color': Color(0xFF8BC34A)}, // Light Green
    'K+': {'elo': 1100, 'skill': 'Sát ngưỡng lên I', 'color': Color(0xFF4CAF50)}, // Green
    'I': {'elo': 1200, 'skill': '3-5 bi; chưa điều được chấm', 'color': Color(0xFF2196F3)}, // Blue
    'I+': {'elo': 1300, 'skill': 'Sát ngưỡng lên H', 'color': Color(0xFF1976D2)}, // Dark Blue
    'H': {'elo': 1400, 'skill': '5-8 bi; có thể "rùa" 1 chấm hình dễ', 'color': Color(0xFF9C27B0)}, // Purple
    'H+': {'elo': 1500, 'skill': 'Chuẩn bị lên G', 'color': Color(0xFF673AB7)}, // Deep Purple
    'G': {'elo': 1600, 'skill': 'Clear 1 chấm + 3-7 bi kế; bắt đầu điều bi 3 băng', 'color': Color(0xFFFF9800)}, // Orange
    'G+': {'elo': 1700, 'skill': 'Trình phong trào "ngon"; sát ngưỡng lên F', 'color': Color(0xFFFF5722)}, // Deep Orange
    'F': {'elo': 1800, 'skill': '60-80% clear 1 chấm, đôi khi phá 2 chấm', 'color': Color(0xFFF44336)}, // Red
    'F+': {'elo': 1900, 'skill': 'Safety & spin control khá chắc; sát ngưỡng lên E', 'color': Color(0xFFD32F2F)}, // Dark Red
    'E': {'elo': 2000, 'skill': '90-100% clear 1 chấm, 70% phá 2 chấm', 'color': Color(0xFF795548)}, // Brown
    'E+': {'elo': 2100, 'skill': 'Điều bi phức tạp, safety chủ động; sát ngưỡng lên D', 'color': Color(0xFF5D4037)}, // Dark Brown
  };
